...
async def chat_handler(message: types.Message):
    ...
    # Реакция только на "Моти" или релпай
    ...
    try:
        ...
        # Исправляем ошибку "column id does not exist" (скриншот 1000029592)
        # Мы удаляем старую кривую таблицу и создаем новую с полем id
