...
# 1. Gemini - чистая инициализация без лишних параметров
...
async def chat_handler(message: types.Message):
    ...
    # Если не зовут и не отвечают - молчим
    ...
    try:
        ...
        prompt = "Ты Ева (зовут Моти), ИИ SatanaClub. Отвечай кратко.\n"
...
async def main():
    # КРИТИЧЕСКИ ВАЖНО: Удаляем вебхук и все накопленные сообщения
